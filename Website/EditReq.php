...
<div class="container" style="margin: auto;">
  <div class="row">
    <div class="col-sm-4">
      <form>
        <div class="form-row">
          <form name='form1' id='form1' method="get" formaction='GetID.php'>
          <div class="form-group col-md-6">
            <label for="inputfname4" style="text-align: center;">Enter ID of User to Edit! (W.I.P)</label>
            <input type="fname" class="form-control" id="inputfname4" style="width: 200px;" placeholder="ID" name="contactid">
            <input type="submit" style="background-color: green;" class="btn btn-primary" id="EditUser" style="margin: 7px; transform: translate(70%, 20%);" formaction="edituser.php" value="Edit User"></input>
          </div>
        </form>
      </div>
    </form>
